    ...
    <main className="subpage-main">
      ...
      <section className="contact-page-panel">
        <a className="contact-row" href={`mailto:${profile.email}`}>
          <IconMail aria-hidden="true" size={20} stroke={1.7} />
          <span>{profile.email}</span>
        </a>
        <a className="contact-row" href={github} target="_blank" rel="noreferrer">
          <IconBrandGithub aria-hidden="true" size={20} stroke={1.7} />
          <span>GitHub</span>
        </a>
        <a className="contact-row" href={linkedin} target="_blank" rel="noreferrer">
          <IconBrandLinkedin aria-hidden="true" size={20} stroke={1.7} />
          <span>LinkedIn</span>
        </a>
        <div className="contact-row">
          <IconMapPin aria-hidden="true" size={20} stroke={1.7} />
